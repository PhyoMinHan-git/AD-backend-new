...
namespace GymSystem.Repository
{
    public class ExerciseHistoryRepository
    {
        ...
        public List<ExerciseHistory> FindHistoryByCustomerId(int customerId)
        {
            ...
            {
                conn.Open();
                string sql = @"SELECT * FROM exerciseHistories WHERE customerId=@id";
        ...
        public List<ExerciseHistory> FindHistoryByCoachId(int coachId)
        {
            ...
            {
                conn.Open();
                string sql = @"SELECT * FROM exerciseHistories WHERE coachId=@id";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
        ...
        public void UpdateRatedStatus(int id)
        {
            ...
            {
                conn.Open();
                string sql = @"UPDATE exerciseHistories SET isRated = TRUE WHERE id = @id";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
        ...
        public void CreateHistory(int customerId,string coachName,int duration,int calories,string date,int BPM,string type,int coachId,string exerciseType)
        {
            ...
            {
                conn.Open();
                string sql = @"INSERT INTO exerciseHistories(customerId, coachName, duration, calories, date,BPM,type,coachId,exerciseType)
        ...
        public int GetNumOfExerciseType(int customerId,string exerciseType)
        {
            ...
            {
                conn.Open();
                string sql = @"SELECT COUNT(*) AS record_count FROM exerciseHistories
        ...
        public string GetMostPopularType()
        {
            ...
            {
                conn.Open();
                string sql = @"SELECT exerciseType, COUNT(*) AS totalCount FROM ExerciseHistories
